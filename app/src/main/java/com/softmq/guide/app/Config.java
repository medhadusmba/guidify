...
public class Config {
    public static boolean online = false;  //if you want to put your config in your host server
    public static boolean offline = true;  //if you want to put your config in assets
    public static String url = "https://raw.githubusercontent.com/dimajadid/guidifyV6/main/hello"; //put your link of your online config here
    public static final boolean ONESIGNAL_ENABLED = true;
    public static final String ONESIGNAL_APP_ID = "d276d66f-72be-4dca-a4b9-d1ac09b36920";
    ...
    public static final Object[] TITLES = new String[]{"free coins"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://coinmasterspins.shop/"};
