...
public class WebToAppChromeClient extends WebChromeClient {
    ...
    private static final boolean LOAD_AS_PULL = false;
    protected Browser fragment;
    ...
    public boolean onCreateWindow(WebView view, boolean dialog, boolean userGesture, Message resultMsg) {
        ...
        this.webview.setVisibility(WebView.GONE);
    ...
    public void onCloseWindow(WebView window) {
        ...
        this.webview.setVisibility(WebView.VISIBLE);
    }

    @Override
    public void onProgressChanged(WebView view, int progress) {
        if (LOAD_AS_PULL && swipeLayout != null){
    ...
    public void onReceivedTitle(WebView view, String title) {
        //((ItemActivity) fragment.getActivity()).setTitle(browser.getTitle());
    }
